...
- Admin driver onboarding: application list, approval action, and referral reporting
- Analytics history: demand prediction list, analytics job list, and ETA loop history
